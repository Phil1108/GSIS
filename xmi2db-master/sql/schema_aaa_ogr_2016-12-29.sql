...
COMMENT ON SCHEMA aaa_ogr IS 'Version vom 07.12.2016 01:20';
...
SELECT UpdateGeometrySRID('ap_fpo', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('aa_antragsgebiet', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_polder', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_historischesflurstueck', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_kondominium', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_baublock', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_aussparungsflaeche', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_soll', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_duene', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_transportanlage', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_wegpfadsteig', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gleis', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bahnverkehrsanlage', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_strassenverkehrsanlage', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_einrichtungenfuerdenschiffsverkehr', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_flugverkehrsanlage', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_hafen', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_testgelaende', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_schleuse', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_ortslage', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_grenzuebergang', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gewaessermerkmal', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_untergeordnetesgewaesser', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_vegetationsmerkmal', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_musterlandesmusterundvergleichsstueck', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_insel', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gewann', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_kleinraeumigerlandschaftsteil', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_landschaft', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_felsenfelsblockfelsnadel', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ap_lto', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_leitung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_abschnitt', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_ast', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ap_lpo', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_seilbahnschwebebahn', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebaeudeausgestaltung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_topographischelinie', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_geripplinie', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gewaesserbegrenzung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_strukturierterfasstegelaendepunkte', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_einschnitt', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_hoehenlinie', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_abgeleitetehoehenlinie', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ap_pto', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_heilquellegasquelle', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_wasserspiegelhoehe', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_nullpunkt', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_punktortau', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_georeferenziertegebaeudeadresse', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_grablochderbodenschaetzung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_wohnplatz', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_markantergelaendepunkt', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_besondererhoehenpunkt', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_hoehleneingang', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ap_ppo', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_sickerstrecke', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_firstlinie', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_besonderegebaeudelinie', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gelaendekante', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_sonstigesbauwerkodersonstigeeinrichtung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bauwerkoderanlagefuersportfreizeitunderholung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bauwerkoderanlagefuerindustrieundgewerbe', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_einrichtunginoeffentlichenbereichen', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_historischesbauwerkoderhistorischeeinrichtung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_turm', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_vorratsbehaelterspeicherbauwerk', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bauwerkimgewaesserbereich', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bauwerkimverkehrsbereich', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_schifffahrtsliniefaehrverkehr', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebaeude', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_anderefestlegungnachstrassenrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_naturumweltoderbodenschutzrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_klassifizierungnachstrassenrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_sonstigesrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_denkmalschutzrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_dammwalldeich', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_punktortag', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bauteil', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_tagesabschnitt', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bewertung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_anderefestlegungnachwasserrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_klassifizierungnachwasserrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_forstrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bauraumoderbodenordnungsrecht', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_schutzzone', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_boeschungsflaeche', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_flurstueck', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebiet_kreis', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebiet_bundesland', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebiet_regierungsbezirk', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebiet_nationalstaat', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_kommunalesgebiet', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebiet_verwaltungsgemeinschaft', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bodenschaetzung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gewaesserstationierungsachse', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_besondereflurstuecksgrenze', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gebietsgrenze', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gewaesserachse', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_strassenachse', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bahnstrecke', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_fahrwegachse', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_fahrbahnachse', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_punktortta', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_stehendesgewaesser', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_meer', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_fliessgewaesser', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_hafenbecken', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bergbaubetrieb', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_friedhof', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_flaechegemischternutzung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_wohnbauflaeche', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_flaechebesondererfunktionalerpraegung', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_industrieundgewerbeflaeche', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_siedlungsflaeche', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_tagebaugrubesteinbruch', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_sportfreizeitunderholungsflaeche', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_halde', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_flaechezurzeitunbestimmbar', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_sumpf', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_unlandvegetationsloseflaeche', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_gehoelz', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_wald', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_heide', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_moor', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_landwirtschaft', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_bahnverkehr', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_weg', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_schiffsverkehr', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_flugverkehr', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_platz', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ax_strassenverkehr', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ta_compositesolidcomponent_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ta_surfacecomponent_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ta_curvecomponent_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ta_pointcomponent_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('au_trianguliertesoberflaechenobjekt_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('au_mehrfachflaechenobjekt_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('au_mehrfachlinienobjekt_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('au_umringobjekt_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('ap_kpo_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('au_punkthaufenobjekt_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('au_koerperobjekt_3d', 'wkb_geometry', 25832);
...
SELECT UpdateGeometrySRID('au_geometrieobjekt_3d', 'wkb_geometry', 25832);
